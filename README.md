...
Note: This was written for KDE Plasma and uses wpctl to change the default audio device and volume.

The program will save your config at this folder:
`~/.config/rust-audio-profile-toggle/config.toml`

Why is it .toml? I'm not sure that's what ChatGPT decided. Maybe more research is needed on my part.
